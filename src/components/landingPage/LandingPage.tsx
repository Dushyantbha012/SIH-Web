      ...
      <main className="flex-1">
        ...
        <section className="py-12 md:py-24 lg:py-32 bg-muted">
          <div className="container px-4 md:px-6 text-center space-y-4">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground">
              Seamlessly integrate Talent Nexus with your existing tools and
              workflows.
            </p>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="p-6 rounded-lg shadow-lg bg-card">
                <CardHeader>
                  ...
                  <CardDescription>
                    Integrate Talent Nexus with your HR information systems.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-2">
        ...
        <section className="bg-card py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 text-center space-y-4">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground">
              Get started with Talent Nexus today and unlock the power of
